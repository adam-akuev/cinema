...
/**
 * Конфигурация Swagger/OpenAPI для документации API сервиса фильмов.
 */
@Configuration
@SecurityScheme(
        name = "bearerAuth",
...
public class SwaggerConfig {
    ...
    /**
     * Создает настройки OpenAPI для сервиса фильмов.
     *
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("Cinema Movie Service API")
                        .version("1.0.0")
                        .description("Микросервис для управления фильмами кинотеатра")
                        .contact(new Contact()
